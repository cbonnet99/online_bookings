...
Country.create(:is_default => true, :country_code => "FR", :name => "France", :locale => "FR", :mobile_phone_prefixes_list => "06,07",
...
Country.create(:is_default => false, :country_code => "NZ", :name => "New Zealand",  :locale => "EN", :mobile_phone_prefixes_list => "021,022,027,029",
